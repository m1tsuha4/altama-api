...
} from './dto/create-category-article.dto';
import {
  UpdateCategoryArticleDto,
  UpdateCategoryArticleSchema,
} from './dto/update-category-article.dto';
...
export class CategoryArticleController {
  ...
  @Post()
  create(
    @Body(new ZodValidationPipe(CreateCategoryArticleSchema))
    createCategoryArticleDto: CreateCategoryArticleDto,
  ) {
  ...
  update(
    @Param('id') id: string,
    @Body(new ZodValidationPipe(UpdateCategoryArticleSchema))
